...
<body>
    ...
    <div class="mt-1">
        <!--Main Content Here -->
        <?php require '../payment/metode.php'; ?>
        <?php require '../payment/instruksi.php'; ?>
        <?php require '../payment/uploads.php'; ?>
        <?php require '../payment/bukti.php'; ?>
        <?php require '../payment/ringkasan.php'; ?>
    </div>
    <!-- JS Bundle -->
